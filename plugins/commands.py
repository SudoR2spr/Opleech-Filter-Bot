...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('⌬ Mᴏᴠɪᴇ Gʀᴏᴜᴘ', url='https://t.me/WD_Topic_Group'),
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
                ...
                InlineKeyboardButton('🤔 Jᴏɪɴᴇᴅ 🤔', callback_data='sinfo')
            ]
        ]
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                ...
                                InlineKeyboardButton('🚀 Fast Download Link', callback_data=f'generate_stream_link:{file_id}') #Don't change anything without contacting me @Opleech
                            ]
                        ]
                    )
                )
