...
async def send_all(bot, userid, files, ident, chat_id, user_name, query):
    ...
    try:
                    ...
                    await bot.send_cached_media(
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            [
                                ...
                                InlineKeyboardButton("𝐁𝐨𝐭 𝐎𝐰𝐧𝐞𝐫", url="t.me/Opleech")
                                ]
                            ]
                        )
                    )
        ...
        await query.answer('𝐇𝐞𝐲, 𝐒𝐭𝐚𝐫𝐭 𝐁𝐨𝐭 𝐅𝐚𝐫𝐬𝐭 𝐀𝐧𝐝 𝐂𝐥𝐢𝐜𝐤 𝐒𝐞𝐧𝐝 𝐀𝐥𝐥', show_alert=True)
    except Exception as e:
        await query.answer('𝐇𝐞𝐲, 𝐒𝐭𝐚𝐫𝐭 𝐁𝐨𝐭 𝐅𝐚𝐫𝐬𝐭 𝐀𝐧𝐝 𝐂𝐥𝐢𝐜𝐤 𝐒𝐞𝐧𝐝 𝐀𝐥𝐥', show_alert=True)
...
async def get_cap(settings, remaining_seconds, files, query, total_results, search):
    ...
    if settings["imdb"]:
        ...
        cap = f"<b>Hᴇʏ {query.from_user.mention}, 𝐅𝐨𝐮𝐧𝐝 {total_results} 𝐑𝐞𝐬𝐮𝐥𝐭𝐬  𝐅𝐨𝐫 𝐘𝐨𝐮𝐫 𝐌𝐨𝐯𝐢𝐞 {search}\n\n</b>"
        cap+="<b><u>🍿 𝐘𝐨𝐮𝐫 𝐌𝐨𝐯𝐢𝐞 𝐅𝐢𝐥𝐞 ⟱</u></b>\n\n"
        for file in files:
            cap += f"<b>📁 <a href='https://telegram.me/{temp.U_NAME}?start=files_{file.file_id}'>[{get_size(file.file_size)}] {' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@') and not x.startswith('www.'), file.file_name.split()))}\n\n</a></b>"
    return cap
