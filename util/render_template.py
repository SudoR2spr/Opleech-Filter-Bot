#Thanks @Opleech helping this journey 
...
async def render_page(id, secure_hash, src=None):
    file = await AngelOpBot.get_messages(int(LOG_CHANNEL), int(id))
    file_data = await get_file_ids(AngelOpBot, int(LOG_CHANNEL), int(id))
