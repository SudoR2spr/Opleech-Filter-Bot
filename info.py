...
BOT_TOKEN = environ.get('BOT_TOKEN', "6736774847:AgH2SgQfyFhxV6BS-I1PkRyXLXl5FBEPaN4")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001571381165')).split()]
